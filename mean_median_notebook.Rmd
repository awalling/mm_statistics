...
```{r}
#To calculate the mean and median numerically...
#Use the built-in functions provided by R!
#Remember to select the appropriate column from your data frame.
mean_mm_weight <- mean(mm_weight[,2])
mean_mm_weight
median_mm_weight <- median(mm_weight[,2])
median_mm_weight
```
